function [p_go]=QRE20_Signal_FirstSecondStageErrors(p_0GG_1G, p_0GS_1G, p_0SG_1G, p_0SS_1G,...
                                ...
                                + p_0S(j)*...
                                       ...
                                       +(1 - p_0SS_1G(j))*(...
                                                 ...
                                                 + (1 - p_0SS_1G(k))*...
                                                                       (...
                                                                       p_0SS_1SS_2G(j)*...
                                                                                       ( p_0SS_1SS_2G*B2Y(k) + (1 - p_0SS_1SS_2G)*5 )... 
                                                                       +(1-p_0SS_1SS_2G(j))*...
                                                                                       ( p_0SS_1SS_2G*B1Y(k,a,b) + (1 - p_0SS_1SS_2G)*7 )... 
                                                                       )...            
                                                           )...
                                    )...
                                );        
